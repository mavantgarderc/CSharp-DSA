...
public class UserController : BaseController
{
    ...
    public async Task<IActionResult> UpdateExistingUser(Guid id, [FromBody] UpdateUserCommand cmd)
    {
        ...
        {
            return StatusCode(500, ApiResponse<bool>.ErrorResult("Unexpected error.", ex.Message));
        }
    }
    ...
    public async Task<IActionResult> ActivateUser(Guid id)
    {
        ...
        {
            return StatusCode(500, ApiResponse<bool>.ErrorResult("Activation failed", ex.Message));
        }
    }
    ...
    public async Task<IActionResult> DeactivateUserAccount(Guid userId)
    {
        try
        {
            ...
            return Ok(ApiResponse<bool>.SuccessResult(success, "User deactivated successfully"));
        }
        catch (KeyNotFoundException ex)
        {
            return NotFound(ApiResponse<bool>.ErrorResult(ex.Message));
