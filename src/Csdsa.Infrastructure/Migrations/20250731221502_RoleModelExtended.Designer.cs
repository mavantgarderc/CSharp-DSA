...
[Migration("20250731221502_RoleModelExtended")]
partial class RoleModelExtended
{
    /// <inheritdoc />
...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("Csdsa.Domain.Models.UserEntities.Role", b =>
            {
                b.Property<Guid>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("uuid")
                ...
                b.HasIndex("CreatedAt")
                    .HasDatabaseName("ix_roles_created_at");

                b.HasIndex("IsDeleted")
                    .HasDatabaseName("ix_roles_is_deleted");

                b.HasIndex("IsDeleted", "CreatedAt")
                    .HasDatabaseName("ix_roles_is_deleted_created_at");

                b.ToTable("roles");
            });

        modelBuilder.Entity("Csdsa.Domain.Models.UserEntities.User", b =>
            {
                b.Property<Guid>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("uuid")
