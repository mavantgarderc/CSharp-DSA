...
namespace Csdsa.Infrastructure.Persistence.Context.Extensions
{
    public static class ModelBuilderExtensions
    {
        ...
        public static void SeedData(this ModelBuilder modelBuilder)
        {
            ...
            var permissions = new[]
            {
                new Permission { Id = Guid.NewGuid(), Name = "Users.Read", Resource = "Users", Action = "Read", Description = "Read user data", CreatedAt = DateTime.UtcNow },
                new Permission { Id = Guid.NewGuid(), Name = "Users.Write", Resource = "Users", Action = "Write", Description = "Create and update users", CreatedAt = DateTime.UtcNow },
                ...
                new Permission { Id = Guid.NewGuid(), Name = "Roles.Write", Resource = "Roles", Action = "Write", Description = "Create and update roles", CreatedAt = DateTime.UtcNow }
            };
